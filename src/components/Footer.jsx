...
const Footer = () => {
  return (
    <>
      <div className="w-full md:flex justify-between items-center py-10 md:gap-1 bg-black h-[120rem]md:h-[350px] mt-40 mb-0" id="container">
        <div className=' w-100% md:w-[80%] flex flex-col justify-center gap-7 border-r border-white px-10 md:px-20 my-10' >
          <div className="logo bg-white px-5 py-3 text-3xl text-black font-extrabold font-anton cursor-pointer hover:opacity-85 rounded-2xl w-full text-center">
            TechiLLA
          </div>
